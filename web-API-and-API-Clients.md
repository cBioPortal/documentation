...
Although we recommend to use [cBioPortalData](/web-API-and-API-Clients.md#cbioportaldata-recommended) for most use cases, it is possible to connect to the API directly using [rapiclient](https://github.com/bergant/rapiclient):
